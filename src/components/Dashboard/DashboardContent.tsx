    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <nav className="flex space-x-4">
          ...
          {['DCP', 'ACP', 'COMMISSIONER', 'INVESTIGATION_OFFICER', 'COMPLAINANT'].includes(user.role) && (
            <button
      ...
      {activeTab === 'create' && (user.role === 'INVESTIGATION_OFFICER' || user.role === 'COMPLAINANT') && <ComplaintForm user={user} onSuccess={() => {}} onCancel={() => {}} />}

      {activeTab === 'manage' && ['DCP', 'ACP', 'COMMISSIONER', 'INVESTIGATION_OFFICER', 'COMPLAINANT'].includes(user.role) && (
